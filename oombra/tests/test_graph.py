"""Tests for oombra.graph — Phase 5: Federated Graph Intelligence."""
from __future__ import annotations

import numpy as np
import pytest

from oombra.graph.schema import (
    NodeType, EdgeType, GraphNode, GraphEdge, ThreatGraph,
)
from oombra.graph.local import (
    build_graph, build_from_attack_map, build_from_ioc_bundle, merge_graphs,
)
from oombra.graph.embeddings import Node2VecLite, GraphAutoencoder
from oombra.graph.correlate import (
    cosine_similarity, find_similar_nodes, cluster_campaigns,
    campaign_summary, detect_shared_campaigns,
)
from oombra.graph.federated import FederatedGraphClient, federated_graph_round

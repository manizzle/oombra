"""
Tests for oombra extraction pipeline — round-trip tests for every format.
"""
...
from oombra.extract import load_file, load_dict
from oombra.models import EvalRecord, AttackMap, IOCBundle

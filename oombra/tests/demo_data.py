"""
Demo data generator for oombra — realistic threat intel for demos and testing.
...
Usage:
    python -m oombra.tests.demo_data --output demo/
    # Generates JSON files ready for `oombra upload` or `oombra preview`
"""

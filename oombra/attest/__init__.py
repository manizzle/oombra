"""
oombra Attested Data Transformation Chain (ADTC)
=================================================
...
In oombra ADTC, you attest that DATA TRANSFORMATIONS were correctly
...
THE PROTOCOL
------------
Like DICE (Device Identifier Composition Engine), each step in the oombra

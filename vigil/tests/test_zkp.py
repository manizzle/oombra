...
from vigil.zkp.contrib_proofs import (
    EvalRecordProof,
    AttackMapProof,
    IOCBundleProof,
    ContributionProofBundle,
)
from vigil.zkp.verify import ZKPVerifier, ZKPVerificationResult
...
class TestEvalRecordProof:
    ...
    def test_all_categories(self, params):
        from vigil.zkp.contrib_proofs import EVAL_CATEGORIES
...
class TestIOCBundleProof:
    ...
    def test_all_ioc_types(self, params):
        from vigil.zkp.contrib_proofs import IOC_TYPES

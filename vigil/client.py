...
Platform-agnostic: point api_url at whatever ingests the vigil wire format.
...
_RECEIPTS_DIR = Path.home() / ".vigil" / "receipts"
...
class Client:
    ...
    def __init__(self, api_url: str, api_key: str | None = None):
        ...
        self.api_key = api_key or os.getenv("VIGIL_API_KEY")
...
def _store_receipt(receipt_hash: str, payload: dict) -> Path:
    """Store receipt in ~/.vigil/receipts/"""
